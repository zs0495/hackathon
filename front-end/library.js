    ...
    const resourcesData = [
{
  ...
  requiredDoc: ["신분증(방문 신청 시)", "구직등록필증(실업자의 경우)", "실업자훈련 동영상 시청확인증(실업자의 경우) 등"],
  keywords: "4 학생 / 5 청년 /  8 취업",
...
},
{
  ...
  requiredDoc: ["인천청년포털(youth.incheon.go.kr)참고 및 인천문화재단 지역문화팀(032-766-5976) 문의"],
  keywords: "인천 / 5 청년 / 3 자영업",
...
},
{
  ...
  requiredDoc: ["진흥원 홈페이지 공고문 참조 및 울산일자리포털 홈페이지 참조"],
  keywords: "울산 / 5 청년 / 8 취업",
...
},
{
  ...
  requiredDoc: ["지원서", "재학증명서", "성적증명서", "자기소개서 및 학업/진로 계획서", "정보보호 및 관련 분야 활동 증빙자료", "개인정보 제공 및 활용 동의서 등 (대학 담당 부서에 제출)"],
  keywords: "전남 / 5 청년 8 취업 / 9 장학금",
  link: "",
  word: ["","","","","정보보호 및 관련 분야 활동 증빙자료"],
  explain: "교육 및 훈련 자료, 기술적 증빙자료 등"
},
{
  id: 8,
  type: "public",
  ...
  requiredDoc: ["지원 신청서", "재학증명서", "성적증명서", "자기소개서 및 진로계획서", "정보통신 및 SW 관련 활동 증빙자료", "개인정보 동의서 등 (대학 담당 부서에 제출)"],
  keywords: "전남 광주 / 5 청년 / 8 취업 / 9 장학금",
  link: "",
  word: "정보 통신 및 SW 관련 활동 증빙자료",
  explain: "교육 및 훈련 자료, 기술적 증빙자료 등"
},
{
  id: 9,
  ...
  eligibility: "제한없음",
  requiredDoc: ["교육/상담 신청서", "개인정보 제공 및 동의서 등"],
  keywords: "8 취업 / 12 교육 / 5 청년",
...
},
{
  ...
  requiredDoc: ["참가신청서", "최종학력증명서(재학/졸업증명서)", "자기소개서 및 직무계획서", "강력/자격증(해당인에 한함)", "개인정보 제공 및 활용 동의서 등"],
  keywords: "5 청년 / 8 취업 / 12 교육",
  link: "https://ofiis.kofpi.or.kr/overseasForest_intern.do",
  word: "직무계획서",
  explain: "특정 직무를 수행하기 위한 구체적인 목표와 방법을 체계적으로 정리한 문서"
},
{
  id: 11,
  type: "public",
  ...
  requiredDoc: ["가족관계증명서", "거주자의 사업소득 원천징수영수증/거주자의 사업소득지급명세서", "간이지급명세서", "사용증명서", "노무제공자.예술인 표준계약서", "용역계약서", "이체확인증", "등"],
  keywords: "3 자영업 / 13 임산부 / 서울",
  link: "https://umppa.seoul.go.kr/hmpg/sprt/pgpt/bzin/bzmgPageDetail.do?biz_mng_no=16A62AE6CE162993E063A6022162A5D2",
  word: "사업소득 원천징수 영수증 ",
  explain: "사업자가 소득을 지급할 때 세금을 미리 떼어 국세청에 납부했다는 것을 증명하는 문서"
},
{
  id: 12,
  type: "public",
...
},
{
  ...
  requiredDoc: ["신분증", "가족관계증명서", "주민등록등본 지참"],
  keywords: "서울 / 2 아동 / 7 한부모 / 10 차상위 / 13 임산부",
...
},
{
  ...
  requiredDoc: ["필요 시 주민등록등본", "가족관계증명서 등"],
  keywords: "서울 / 4 학생 / 5 청년 / 6 질병 / 10 차상위 / 12 장애인 ",
...
},
{
  ...
  requiredDoc: ["푸드뱅크 마켓 서비스 이용 신청서"],
  keywords: "서울 / 7 한부모 / 10 차상위 ",
...
},
{
  ...
  requiredDoc: ["홈페이지(seoulhanbumo.or.kr) 내 신청서"],
  keywords: "서울 / 2 아동 / 7 한부모 / 10 차상위 / 13 임산부",
...
},
{
  ...
  requiredDoc: ["방문 전 동주민센터에 필요 서류 문의"],
  keywords: "서울 / 1 국가유공자 ",
...
},
{
  ...
  requiredDoc: ["신분증 및 독립유공자 선순위유족 등 국가유공자 확인가능한 서류(증서 등)"],
  keywords: "서울 / 1 국가유공자 / 6 질병",
  link: "",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["주민등록등본", "신분증 사본", "개인정보 수집.제공.이용 동의서", "지원 신청서 등"],
  keywords: "서울 / 5 청년 / 6 질병 / 12 교육",
...
},
{
  ...
  requiredDoc: ["사회복지서비스 및 급여제공(변경) 신청서", "사회복지서비스 이용권(바우처) 제공(변경) 신청서", "아이사랑 카드발급 신청 및 개인신용정보의 조화.제공.이용 동의서"],
  keywords: "2 아동 / 12 교육",
...
},
{
  ...
  requiredDoc: ["취업지원신청서 및 지원자격 확인을 위한 개인정보 수집", "이용 및 제공 동의서 (필요시 추가서류는 홈페이지 참고)"],
  keywords: "4 학생 / 5 청년 / 8 취업 /  12 교육",
...
},
{
  ...
  requiredDoc: ["신분증(주민등록증)", "임신부는 산모수첩 등 임신여부를 확인할 수 있는 서류"],
  keywords: "2 아동 / 6 질병 / 13 임산부 / 15 노인",
...
},
{
  ...
  requiredDoc: ["소득 및 재직 증빙 서류", "개인 정보 제공동의서 등"],
  keywords: "5 청년 / 7 한부모 / 10 차상위 /  16 거주 / 17 부부",
...
},
{
  ...
  requiredDoc: ["적성검사(갱신) 신청서 동의란에 체크"],
  keywords: "5 청년 / 7 한부모 / 10 차상위 ",
...
},
{
  ...
  requiredDoc: ["출산전후휴가: 출산전후휴가 급여등 신청서", "확인서", "확인할 수 있는 자료 등 / 유산", "사산휴가: 출산전후휴가 급여등 신청서", "사산휴가 확인서", "통상임금 확인할 수 있는 자료 등"],
  keywords: "13 임산부",
...
},
{
  ...
  requiredDoc: ["필수서류: 없음", "선택서류: 국가장학금 신청정보와 한국장학재단에서 신청자에 대한 정보가 불일치할 경우 별도 제출 필요"],
  keywords: "4 청년 / 9 장학금 / 12 교육 / 14 금융",
...
},
{
  ...
  requiredDoc: ["공통서류: 대부 신청서", "대부 약정서", "개인 정보의 수집.이용 및 조회 및 제공동의서", "대부 신청자 신분증 / 추가서류: 진료비 계산서", "영수증 등"],
  keywords: "14 금융 / 15 노인",
...
},
{
  ...
  requiredDoc: ["공인인증서 등록 혹은 간편인증을 통한 거주지 확인", "실제 사용중인 본인 교통카드 정보", "환급받을 지역화폐 정보(온라인 신청 시 정보 등록) 혹은 똑타 앱을 통한 공유자전거 이용요금 결제"],
  keywords: "경기도 / 2 아동 / 4 학생 / 14 금융",
...
},
{
  ...
  requiredDoc: ["신분증", "수급자 증명 서류"],
  keywords: "10 차상위 / 14 금융 / 15 노인",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["사업자등록증", "매출 증빙 서류 등"],
  keywords: "3 자영업 / 14 금융",
  link: "https://www.sbiz24.kr/#/",
  word: "사업자등록증",
  explain: "사업자가 세무서에 사업 개시를 신고하고 받급받는 공식 문서"
},
{
  id: 106,
  type: "public",
  ...
  requiredDoc: ["사업주 등록증", "근로자 서류"],
  keywords: "8 취업 / 3 자영업 / 14 금융",
...
},
{
  ...
  requiredDoc: ["수급자 증명서", "신분증 등"],
  keywords: "7 한부모 / 10 차상위",
...
},
{
  ...
  requiredDoc: ["신분증", "수급자증명서", "소득확인서 등"],
  keywords: "7 한부모 / 10 차상위 / 14 금융",
...
},
{
  ...
  requiredDoc: ["신분증", "의료비 영수증", "소득 증빙서류", "수급자 증명서 등"],
  keywords: "7 한부모 / 10 차상위 / 6 질병 / 14 금융",
  link: "https://plus.gov.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["양육비 집행권원 관련 서류(예. 법원의 양육비 판결문)", "양육비 미지급 증명 서류", "양육비 이행 확보 증명 서류", "통장 사본", "기본증명서(신청인과 자녀 각각 1부)", "혼인관계증명서(신청인 1부)"],
  keywords: " 2 아동 / 4 학생 / 7 한부모가정 / 10 차상위 / 14 금융",
...
},
{
  ...
  requiredDoc: ["신분증(주민등록증)", "필요시 소득기준 확인 위한 서류"],
  keywords: "5 청년 / 6질병 / 15 노인 ",
  link: "",
  word: "",
  explain: ""
},
...
},
{
  ...
  requiredDoc: ["온라인 신청서 제출"],
  keywords: "4 학생 / 6 질병 / 12 교육",
...
},
{
  ...
  requiredDoc: ["신청서", "신분증 사본", "성폭력 피해 입증자료(해당인에 한함)", "개인정보 제공 및 동의서 등"],
  keywords: "6 질병",
  link: "bokjiro.go.kr",
  word: "성폭력 피해 입증자료",
  explain: "고소장, 진단서, 사건 관련 사진/영상 등 , 가해자와 주고받은 문자 메시지, 진료기록 등"
},
{
  id: 36,
  type: "public",
  ...
  requiredDoc: ["가족관계 확인서류", "수급계좌 통장 사본 등"],
  keywords: "7 한부모 / 10 차상위 / 2 아동 / 4 학생",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신분증 (대리 신청 시 가족관계증명서)", "주민등록등본", "사회보장급여 수급자 증빙서류", "(해당자에 한함) 차상위계층 확인서 등"],
  keywords: "7 한부모 / 10 차상위 / 4 학생 / 5 청년",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["가입신청서 작성 없이 이용 가능"],
  keywords: "2 아동 / 13 임산부 / 17 부부",
...
},
{
  ...
  requiredDoc: ["월세지원 신청서 및 서약서", "본인 확인 및 가족관계 증빙서류", "소득.재산 신고서", "임대차 계약서 및 월세 이체 증빙서류", "본인 명의 통장 사본", "청약통장 사본 등"],
  keywords: " 5 청년 / 14 금융 / 16 거주",
  link: "bokjiro.go.kr",
  word: "재산 신고서",
  explain: "개인이나 가구의 소유 재산을 신고하는 공식 문서"
},
{
  id: 40,
  type: "public",
  ...
  requiredDoc: ["사회보장급여 신청(변경)서", "소득.재상 신고서", "신분증 사본", "주민등록등본 혹은 가족관계증명서", "통장 사본", "초.중.고 재학증명서 혹은 입학증명서 등"],
  keywords: "7 한부모 / 10 차상위 / 4 학생 / 12 교육",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
...
},
{
  ...
  requiredDoc: ["가족관계증명서", "신고서 등"],
  keywords: "2 아동 / 7 한부모 / 13 임산부 / 17 부부",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
...
},
{
  ...
  requiredDoc: ["신분증", "소득.재산 증빙서류", "의료보험증"],
  keywords: "10 차상위 / 7 한부모",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["의료비 영수증", "신분증", "수급자 증명서"],
  keywords: "6 질병 / 10 차상위 / 7 한부모",
  link: "bokjiro.go.kr",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신분증", "가족관계증명서", "임대차계약서", "체납확인서류", "소득 및 재산 증빙서류", "통장 사본", "위기 상황 증빙서류 등"],
  keywords: " 16 거주 / 7 한부모 / 10 차상위",
  link: "https://www.myhome.go.kr/hws/portal/cont/selectEmergencyHousingSupView.do",
  word: "위기 상황 증빙서류",
  explain: "일반적으로 사고, 질병, 재난 등으로 인한 피해 사실 증명하는 각종 진단서, 경찰서 신고서, 피해 확인서 등"
},
{
  id: 42,
  type: "public",
  ...
  requiredDoc: ["주거지원 신청서", "개인정보 수집.이용 및 제3자 제공 동의서", "주민등록등본", "소득 및 재산 증빙서류", "체납 확인서류", "통장 사본 등"],
  keywords: "10 차상위 / 16 거주 / 7 한부모",
  link: "ㅇ",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["주민등록등본", "소득 및 재산 관련 증빙서류", "통장 사본", "경찰신고서 (해당자에 한함)", "주거상향 대상자 유형 확인서 등"],
  keywords: "10 차상위 / 16 거주 / 7 한부모",
  link: "ㅇ",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["주민등록등본 가족관계증명서 및 혼인관계증명서", "신분증 사본", "매매(분양)계약서", "주택 등기사항전부증명서", "근로자 소득 증빙서류", "통장사본", "혼인 예정 증빙 서류(해당자에 한함) 등"],
  keywords: "16 거주 / 17 부부",
  link: "https://nhuf.molit.go.kr/FP/FP05/FP0503/FP05030601.jsp",
  word: "혼인 예정 증빙 서류",
  explain: "예식장 계약서나 청첩장 등"
},
{
  id: 45,
  type: "public",
  ...
  requiredDoc: ["사회보장급여 제공(변경) 신청서(신청인의 신분증 지참)", "청년 주거급여 분리지급 신청서", "임차(전대차)가구임을 증빙할 수 있는 서류", "최근 3개월 내 임차료 증빙 서류", "통장사본"],
  keywords: "5 청년 / 10 차상위 / 16 거주 / 7 한부모",
...
},
{
  ...
  requiredDoc: ["주민등록등본", "보호 종료 확인서류", "소득 및 재산 신고서류", "주거 현황 증명서", "통장 사본 등"],
  keywords: "5 청년 / 16 거주",
  link: "https://www.myhome.go.kr/hws/portal/cont/selectYouthPolicyProtectEndChildView.do#guide=MENU003",
  word: "보호 종료 확인서류",
  explain: "가정위탁이나 아동복지시설에서 보호받던 청소년이 보호가 종료됐음을 공식적으로 확인하는 - 퇴소사실증명서 혹은 보호종료확인서"
},
{
  id: 47,
  type: "public",
  ...
  requiredDoc: ["소득확인증명서", "원천징수영수증(근로.기타소득)", "급여명세표", "병역 이행 확인 서류(해당자에 한함)"],
  keywords: " 5 청년 / 16 거주",
  link: "https://www.myhome.go.kr/hws/portal/cont/selectYouthPolicyYouthPassbookView.do#guide=HF218",
  word: "원천징수 영수증",
  explain: "근로자가 1년 동안 받은 소득에 대해 이미 세금이 떼어져(원천징수) 납부된 내역을 상세히 기록한 공식 문서"
},
{
  id: 48,
  type: "public",
  ...
  requiredDoc: ["신분증 사본", "주민등록등본", "소득증빙서류", "임대차계약서", "통장사본", "가족관계증명서(세대주가 아닐 경우)", "기타 금융기관 요구 서류 등"],
  keywords: "17 부부 / 5 청년 / 16 거주 / 14 금융",
...
},
{
  ...
  requiredDoc: ["신분증 사본", "주민등록등본", "소득증빙서류", "입주자저축 납입 증명서", "혼인관계증명서(해당자에 한함)", "혼인 예정 증빙 서류(해당자에 한함)", "통장사본", "가족관계증명서(세대주가 아닐 경우)", "기타 금융기관 요구 서류 등"],
  keywords: "16 거주 / 17 부부",
...
},
{
  ...
  requiredDoc: ["주민등록등본 및 가족관계증명서", "혼인관계증명서(해당자에 한함)", "소득증빙서류", "신분증 사본", "금융계좌 통장 사본", "기타 은행별 필요서류 등"],
  keywords: "5 청년 / 7 한부모 / 10 차상위 / 16 거주 / 17 부부",
...
},
{
  ...
  requiredDoc: ["031-785-3451 상담신청"],
  keywords: "7 한부모 / 9 장학금 / 10 차상위 / 12 교육",
...
},
{
  ...
  requiredDoc: ["신청자격 증빙서류 (재학증명서", "졸업증명서 등 / 메일 혹은 직접 제출 가능)"],
  keywords: "12 교육",
...
},
{
  ...
  requiredDoc: ["구글폼 신청서 제출"],
  keywords: "7 한부모 / 12 교육",
...
},
{
  ...
  requiredDoc: ["전국 보건소 금연클리닉에 문의"],
  keywords: "6 질병 / 4 학생 / 5 청년 ",
...
},
{
  ...
  requiredDoc: ["주소지 시.군.구 보건소에 문의"],
  keywords: "6 질병 /2 아동 / 4 학생 ",
  link: "https://www.e-health.go.kr/gh/heSrvc/selectHeOrgMainInfo.do?ctprCd=1&menuId=200087",
  word: "",
  explain: ""
},
...
},
{
  ...
  requiredDoc: ["국민건강보험공단에서 발송한 건강검진표", "신분증"],
  keywords: "6 질병",
...
},
{
  ...
  requiredDoc: ["국민건강보험공단에서 발송한 건강검진표"],
  keywords: "6 질병 / 2 아동",
...
},
{
  ...
  requiredDoc: ["최근 3개월 이내 발급된 진단서", "가족관계증명서", "신청자 통장 사본 등"],
  keywords: "6 질병",
...
},
{
  ...
  requiredDoc: ["대상자가 수술하기 전 무릎 관절 수술 지원신청서와 구비서류 구비"],
  keywords: "6 질병 / 15 노인 / 10 차상위",
  link: "https://www.e-health.go.kr/gh/heSrvc/selectHeOrgMainInfo.do?ctprCd=1&menuId=200087",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["관할 보건소에 문의"],
  keywords: "6 질병 / 2 아동 / 10 차상위",
  link: "https://www.e-health.go.kr/gh/heSrvc/selectHeOrgMainInfo.do?ctprCd=1&menuId=200087",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신분증", "진단서", "소득 증빙서류 (해당자에 한함) 등"],
  keywords: "6 질병 / 10 차상위 / 15 노인",
...
},
{
  ...
  requiredDoc: ["산모 건강진단서", "신생아 건강검진서"],
  keywords: "6 질병 , 2 아동 / 13 임산부",
...
},
{
  ...
  requiredDoc: ["신분증", "건강검진 결과서", "병력서류 등"],
  keywords: "6 질병",
  link: "https://www.e-health.go.kr/",
  word: "",
  explain: ""
...
},
{
  ...
  requiredDoc: ["장학사업 신청서", "주민등록등본 및 가족관계증명서 수급자 증명서", "소득증빙자료", "재학증명서", "성적증명서", "자기소개서 및 추천서 등"],
  keywords: "7 한부모 / 10 차상위 / 4 학생 / 5 청년 / 9 장학금",
...
},
{
  ...
  requiredDoc: ["지정 인성도서 중 1권을 읽고 독서편지(A4 1장 이상) 작성", "내용에 책 선정 이유", "인상 깊은 부분", "변화된 점 포함 (편지는 [저자]", "[책 속 인물]", "[자신]", "[지인] 등 자유롭게 선택하여 쓸 수 있음"],
  keywords: "4 학생 / 5 청년 / 12 교육",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["공모전/캠페인 응모신청서", "본인의 체험 수기.에세이.사진.영상파일 등 주제별 창작물", "개인정보 제공 및 저작권 동의서 등"],
  keywords: "9 장학금",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["참가신청서", "자기소개서 및 리더십 활동 계획서", "학생증 사본 또는 재학(졸업)증명서", "소속학교 혹은 기관장 추천서(해당자에 한함)", "보호자 동의서 및 개인정보 동의서 등"],
  keywords: "4 학생 / 12 교육",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신청서", "주민등록등본 및 가족관계증명서", "위기 상황 증빙서류", "소득증빙서류", "자기소개서 및 성장계획서 등"],
  keywords: "7 한부모 / 10 차상위 / 4 학생 / 9 장학금",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["가족 캠프 참가 신청서", "참가 가족 정보", "자녀 연령 증빙 자료", "개인정보 제공 및 동의서", "참가비"],
  keywords: "4 학생 / 12 교육 / 17 부부",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["참가 신청서", "학생증 또는 재학(졸업)증명서", "개인정보 제공 및 보호자 동의서", "단체 참가 시 학교 또는 기관장 추천서(해당자에 한함) 등"],
  keywords: "4 학생 / 12 교육",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["지원사업 참가/신청서", "기관소개 및 장애인 참여자 명단", "활동 계획서 및 경로탐사 결과 보고서(활동 종료 후)", "개인정보 동의서 및 환경개선 필요 증빙(환경개선사업 시) 등"],
  keywords: "11 장애인 / 12 교육",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["참가 신청서", "가족 구성원 정보", "개인정보 수집 및 이용 동의서 등"],
  keywords: "12 교육 ",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  eligibility: "관심 있는 대상 누구나",
  requiredDoc: ["참여기간 내 지정 도서 읽고 마음에 남는 문장 인증(사진이나 글로 남김)", "7개 이상 인증 도장 완성 시 완주 인정과 다양한 선물 제공"],
  keywords: "12 교육 ",
  link: "https://www.kbedu.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["의료비 지원 신청서", "진단서 및 치료계획서", "의료비 영수증 및 청구서", "주민등록등본 및 가족관계증명서", "소득.재산 증빙서류", "통장사본 등"],
  keywords: "7 한부모 / 10 차상위 / 6 질병",
...
},
{
  ...
  requiredDoc: ["사회복지서비스 희망드림 지원 신청서", "신분증 사본", "주민등록등본", "소득 및 재산 증빙서류", "거주확인용 임대차계약서 또는 주거 관련 서류 등"],
  keywords: "7 한부모 / 10 차상위 / 9 장학금",
...
},
{
  ...
  requiredDoc: ["사업신청서", "사업계획서", "법인 등기부 등본 또는 비영리단체 등록증", "최근 사업실적 및 회계보고서", "대표자 및 주요 임원 명단 등"],
  keywords: "3 자영업",
...
},
{
  ...
  requiredDoc: ["사업자등록증명원", "진단서", "병원비 영수증", "민간보험 가입서류 및 지급내역", "건강보험 자격확인서 및 납부확인서", "신분증 사본", "통장사본"],
  keywords: "3 자영업 / 6 질병",
...
},
{
  ...
  requiredDoc: ["개인 정보 수집 및 활용 동의서", "경제 상황 증빙서류", "위기 상황 증빙서류", "사례관리기관 추천 공문 및 신청서", "통장사본"],
  keywords: "7 한부모 / 10 차상위",
  link: "sosdwego.co.kr",
  word: "경제 상황 증빙서류 ",
  explain: "기초생활수급자 증명서, 차상위계층 확인서, 주민등록등본, 건강보험 자격확인서, 건강보험료 납부 혹인서 등"
},
{
  id: 95,
  type: "private",
  ...
  requiredDoc: ["필요 서류 없이 누구나 방문 가능"],
  keywords: "7 한부모 / 10 차상위 / 4 학생",
...
},
{
  ...
  requiredDoc: ["돕돕프로젝트 신청서", "가족관계증명서", "주민등록등본", "소득증빙서류", "학교생활기록부 또는 재학증명서(해당 시) 등"],
  keywords: "2 아동 / 4 학생 / 7 한부모 / 10 차상위",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신청서", "주민등록등본", "소득증빙서류", "재학증명서 또는 졸업증명서", "신분증 사본", "자기소개서 또는 지원 동기서"],
  keywords: "5 청년 / 7 한부모 / 10 차상위 / 8 취업 / 12 교육",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["복지 서비스 신청서", "가족관계증명서 및 주민등록등본", "다문화가족 증명서류", "소득 및 재산 증빙서류", "보호자 신분증 사본", "학교 재학증명서 또는 신분 확인 서류 등"],
  keywords: "2 아동 / 4 학생 / 7 한부모 / 10 차상위",
  link: "https://www.elandcsr.or.kr/",
  word: "다문화 가족 증명서류",
  explain: "본인 또는 배우자의 가족관계증명서와 혼인관계증명서, 외국인 등록증 사본을 함께 제출 "
},
{
  id: 99,
  type: "private",
  ...
  requiredDoc: ["사업 신청서 및 사업 계획서", "법인 등기부등본 또는 단체 등록증 사본", "최근 사업 실적 및 활동 보고서", "예산서 및 회계 계획서", "단체 소개서 및 주요 임원 명단 등"],
  keywords: "3 자영업",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신청서", "신분증 사본", "주민등록등본 및 가족관계증명서", "소득증빙서류", "임대차계약서 또는 주택구입 계약서", "금융거래통장 사본 등"],
  keywords: "5 청년 / 16 거주 / 17 부부",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["복지서비스 신청서", "주민등록등본", "소득 및 재산 증빙서류", "학교 생활기록부 또는 재학증명서", "자기소개서 및 진로 설계서 등"],
  keywords: "4 학생 / 7 한부모 / 10 차상위 / 12 교육",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["지원사업 신청서", "주민등록등본 및 가족관계증명서", "소득 및 재산 증빙서류 등"],
  keywords: "7 한부모 / 10 차상위",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["지원사업 신청서", "신분증 사본 및 주민등록등본", "소득 및 재산 증빙서로", "의료지원 시 진단서 등"],
  keywords: "10 차상위 / 15 노인",
  link: "https://www.elandcsr.or.kr/",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신청서", "주민등록등본", "소득증빙서류", "주거 계약서", "자기소개서", "등"],
  keywords: "5 청년 / 9 장학금",
...
},
{
  ...
  requiredDoc: ["신청서", "가족관계증명서", "의료비 지출 내역 증빙 서류", "건강보험 증명서", "주민등록등본", "소득증빙 서류", "등"],
  keywords: "2 아동 / 4학생 / 6 질병 / 7 한부모 / 10 차상위",
...
},
{
  ...
  requiredDoc: ["신청서", "신분증", "가족관계증명서 또는 주민등록등본", "안전 위협 또는 피해 관련 증빙서류", "주거 확인 서류", "기타 기관 요청 서류"],
  keywords: "4 학생 / 5 청년",
  link: "http://www.kfccf.or.kr/business/neighbor_n.jsp",
  word: "안전 위협 또는 피해 관련 증빙 서류",
  explain: "위험 또는 피해 사실을 입증하는 공식 자료"
},
{
  id: 74,
  type: "private",
  ...
  requiredDoc: ["보조기기 지원 신청서", "장애인 등록증 또는 장애진단서", "의료검사 결과 및 진료 기록지", "소득증빙서류", "가족관계증명서 및 주민등록등본 등"],
  keywords: "7 한부모 / 10 차상위 / 11 장애인",
  link: "http://www.kfccf.or.kr/business/neighbor_n.jsp",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["행사지원 신청서", "사업계획서 또는 행사 계획서", "단체 소개서 및 관련 법인등록증(비영리단체의 경우)", "예산계획서 및 사용 계획 서류", "지원 대상자 선정 기준 및 명단 (필요 시)", "후기 보고서 및 사진 기록 제출 (행사 후)"],
  keywords: "7 한부모 / 10 차상위 / 15 노인",
...
},
{
  ...
  requiredDoc: ["신청서", "사업계획서", "기관 등록증 및 법인등기부등본", "최근 사업실적 및 운영 보고서", "예산 계획서 및 재정 상태 증빙서류", "차량 견적서 또는 임대 계약서", "대표자 신분증 사본"],
  keywords: "3 자영업",
  link: "http://www.kfccf.or.kr/business/network_n.jsp",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["신청서 및 사업계획서", "기관 등록증 사본 또는 운영증명서", "최근 교육 활동 실적 보고서(해당 시)", "예산 계획서 및 지원금 사용 계획 등"],
  keywords: "4 학생 / 12 교육",
  link: "http://www.kfccf.or.kr/business/network_n.jsp",
  word: "",
  explain: ""
},
{
  ...
  requiredDoc: ["에너지 지원 신청서", "주민등록등본", "소득 및 재산 증빙서류", "에너지 사용 내역 증빙자료", "신분증 사본 등"],
  keywords: "7 한부모 / 10 차상위",
...
},
{
  ...
  requiredDoc: ["사업신청서", "사업계획서", "단체 소개서 및 법인등록증 또는 비영리단체 등록증 사본", "예산서 및 회계 계획서", "최근 사업실적 및 활동보고서", "대표자 및 참여자 명단 등"],
  keywords: "3 자영업",
  link: "http://www.kfccf.or.kr/business/develop.jsp",
  word: "",
  explain: ""
